...
public class Anagram {
    ...
    static void printAnagramsTogether(String wordArr[], int size) {
        ...
        // in given wordArr. The copy will also have original indexes of words
        ...
        // but these words are changed. Use the index member of word struct to get the corresponding original word
        for (i = 0; i < size; ++i)
            System.out.print(
